...
gulp.task('styles', function() {
	return gulp.src('src/wp-content/themes/'+template+'/assets/sass/**/*.sass')
	.pipe(sass({
        style: 'compressed',
	...
	.pipe(gulp.dest('src/wp-content/themes/'+template+'/assets/css'))
...
gulp.task('scripts', function() {
	...
	.pipe(gulp.dest('src/wp-content/themes/'+template+'/assets/js'))
...
gulp.task('imgmin-theme', function() {
	return gulp.src('src/wp-content/themes/'+template+'/assets/images/**/*')
	.pipe(cache(imagemin())) // Cache Images
	.pipe(gulp.dest('src/wp-content/themes/'+template+'/assets/images'));
});
...
gulp.task('deploy-theme', function() {
	...
	var globs = [
	'src/wp-content/themes/'+template+'/**', // Путь до шаблона у вас на компьютере
	];
	return gulp.src(globs, {buffer: false})
	.pipe(conn.dest('/httpdocs/wp-content/themes/'+template+'/')); // Путь до шаблона на хостинге
});
...
if (gulpversion == 3) {
  gulp.task('watch', ['styles', 'scripts', 'browser-sync'], function() {
	  gulp.watch(['src/wp-content/themes/'+template+'/assets/sass/**/*.sass'], ['styles']); // Наблюдение за sass файлами в папке sass в теме
	  gulp.watch(['src/wp-content/themes/'+template+'/assets/libs/**/*.js', 'src/wp-content/themes/'+template+'/assets/js/common.js'], ['scripts']); // Наблюдение за JS файлами js в теме
    gulp.watch('src/wp-content/themes/'+template+'/**/*.php', browsersync.reload) // Наблюдение за sass файлами php в теме
  });
...
if (gulpversion == 4) {
	gulp.task('watch', function() {
		gulp.watch('src/wp-content/themes/'+template+'/assets/sass/**/*.sass', gulp.parallel('styles')); // Наблюдение за sass файлами в папке sass в теме
		gulp.watch(['src/wp-content/themes/'+template+'/assets/libs/**/*.js', 'src/wp-content/themes/'+template+'/assets/js/common.js'], gulp.parallel('scripts')); // Наблюдение за JS файлами в папке js
    gulp.watch('src/wp-content/themes/'+template+'/**/*.php', browsersync.reload) // Наблюдение за sass файлами php в теме
	});
